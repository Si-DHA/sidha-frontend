...
export default function ProfilePage() {
  ...
  return (
    <main
      className={`flex min-h-screen flex-col items-center justify-center align-middle min-h-screen ${inter.className}`} data-theme="cmyk"
    >

      <Drawer userRole={userRole}>

        <div className="hero flex flex-col align-middle min-h-screen mx-auto my-aut">
          <div className="flex flex-row gap-y-12 gap-x-12 justify-center items-center">
