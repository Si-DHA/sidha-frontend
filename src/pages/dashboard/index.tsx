                ...
                <div className="flex flex-col justify-center items-center mih-h-screen">
                    ...
                    <div className="flex flex-row justify-center mx-sm gap-y-5">
                        <div className="stats shadow m-5">
                            ...
                            <div className="stat bg-neutral text-white">
                                <div className="stat-figure text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" fill="#ffffff" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                                </div>
